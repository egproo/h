...
class dashboardWidget3 extends ApexChartWidget
{
    /**
     * Chart Id
     *
     * @var string
     */
    protected static string $chartId = 'dashboardWidget3';
    ...
    $completedAppointments = Appointment::where('user_id', $user_id)->where('status', 'قيد التنفيذ')->count();
/*
