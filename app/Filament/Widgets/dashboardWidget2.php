...
class dashboardWidget2 extends ApexChartWidget
{
    /**
     * Chart Id
     *
     * @var string
     */
    protected static string $chartId = 'dashboardWidget2';
    ...
    $completedAppointments = Appointment::where('user_id', $user_id)->where('status', 'في الانتظار')->count();
/*
						'في الانتظار' => '',
