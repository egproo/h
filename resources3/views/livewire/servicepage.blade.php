...
@foreach($providers as $provider)
      <div  wire:key="{{$provider->id}}"  class="u-align-left u-container-style u-expanded-width u-group u-radius-12 u-shape-round u-white u-group-2">
        <div class="u-container-layout u-container-layout-2">
          ...
          <span wire:click="redirectToBookingOrLogin({{ $provider->id }}, {{ $service->id }})"
            class="u-border-2 u-border-grey-75 u-btn u-btn-round u-button-style u-custom-color-2 u-custom-font u-hover-custom-color-1 u-radius-10 u-btn-1">حجز</span>
        </div>
      </div>
		@endforeach	  
@if(count($providers) == 0)
